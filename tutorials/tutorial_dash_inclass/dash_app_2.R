...
app %>% set_layout(
  ...
  html$h2("And look at the outout values you get"),
  div(id="output1"),
  div(id="output2"),
  div(id="output3"),
  div(id="output4"),
...
app %>% add_callback(
  ...
  function(input1,
    ...
    list(
      ...
      sprintf("Ouput of dccRadioItems: \"%s\"", input3),
      sprintf("Ouput of dccDropdown: \"%s\"", input4),
      sprintf("Ouput of dccSlider: \"%s\"", input5),
      sprintf("Ouput of dccInput: \"%s\"", input6)
    )
  }
)
